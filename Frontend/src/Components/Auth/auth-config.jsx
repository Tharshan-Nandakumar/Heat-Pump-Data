...
export const msalConfig = {
  auth: {
    ...
    redirectUri: "http://localhost:5173/", //https://heat-pump-data-frontend.vercel.app", // Points to window.location.origin. You must register this URI on Microsoft Entra admin center/App Registration.
