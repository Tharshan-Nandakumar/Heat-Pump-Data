...
export const msalConfig = {
  auth: {
    ...
    redirectUri: "https://heat-pump-data-frontend.vercel.app", // Points to window.location.origin. You must register this URI on Microsoft Entra admin center/App Registration.
